...
\end{lstlisting}
Die Methode prüft, ob das TreeNode-Objekt noch weitere Kinder aufnehmen kann. Falls ja, fügt es sich selbst sowie die Kosten des potenziellen neuen Kindes einem Dictionary hinzu.
...
\subsection{Verbessern des Baumes}
