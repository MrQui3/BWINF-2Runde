...
Das nach oben verschobenene Blatt erhält den Zusatz $protected$. Die verhindert, dass es sselbst weitere Kinder bekommen kann.
...
Die Anzahl der notwendigen Iterationen wird so berechnet:
\begin{equation}
  \label{equation:iterationen}
  \frac {i}{r}
\end{equation}
wobei:\\
- $i$ die Anzahl der Buschstaben sind\\
- $r$ die Anzahl der Perlen sind  \\
Es wird sich dann für die Iterationen mit den geringsten Kosten entschieden.
Die Begründung für diese Abbrechbedinung liegt darin, dass 
