...
Die Methode $find\_best\_tree$ versucht, den übergebenen Baum so lang zu optimieren, bis alle Blätter als $protected$ markiert sind.
...
Abbildung \ref{fig:iteration_tree} zeigt wie die Länge der codierten Nachricht von Beispielaufgabe $schmuck9$ sich über die Iterationen verhält. 
