...
Generell gilt um die maximale Anzahl an innere Knoten zu kriegen, muss jeder Knoten eine möglichst geringe Anzahl an Kindern haben.
Wie oben festgelegt, hat jedere innere Knoten mindestens zwei Kinder. 
Daraus folgt, dass die Anzahl an innere Knoten bei einem Binbaum am größten ist und wird daher durch 
\begin{equation}
  I = w - 1
\end{equation}
wobei w die Anzahl an Blättern/Codewörter ist
berechnet
