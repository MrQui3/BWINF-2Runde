...
Für beide Züge werden daraufhin die neuen Positionen berechnet:
\begin{lstlisting}
...
Mit dem folgenden Aufruf wird Anschließend überprüft, ob die neuen Positionen bereits beuscht wurden:
\begin{lstlisting}
...
\end{lstlisting}
Zum Schluss wird ein neues $Move$-Objekt aus beiden möglichen Zügen erstellt und übergeben.
...
\subsection{Laufzeit}
Wie schon oben erwähnt beeinflussst $l$, also wie viele unterschiedliche Wege gespeichert werden, die Laufzeit und genauigkeit des Algorithmus stark.
\begin{figure}[h]
  \centering
