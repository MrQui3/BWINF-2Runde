...
Daraufhin werden alle benachbarten Felder mit der Methode $get\_neighbors$ ermittelt und dem Stack hinzugefügt.
...
\begin{lstlisting}
  new_moves = solving_obj.neighbors_cost(move)
\end{lstlisting}
eine Liste von möglichen Folgewege erzeugt
Diese neuen Wege werden der Liste hinzugefügt, sortiert und auf die $l$ besten Wege beschränkt.
