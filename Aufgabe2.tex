...
\clearpage
\section{Beispiele}
Zu jedem Beispiel werden der optimale Lösungsweg sowie die Anzahl der Iterationen in Abhängigkeit vom Parameter~$l$ dargestellt.
...
Pfade über 1400 Schritte sind gekürzt und nur der Anfang und des Ende dargestellt.
...
Das zweite Labyrinth lässt sich nicht lösen, da eine Grube sich auf der Position (18, 6) befindet.
Daher gibt es keinen Weg von Startposition zum Ziel.
Der Algorithmus erkennt solche Fälle und gibt aus, dass er keinen Weg gefunden hat.  
