...
– je höher dier Wert, desto effizienter ist der bisherige Pfad. Dabei ist 2 der maximal erreichbare Wert.
\\
...
Von jeder Position aus existieren zwei mögliche Schritte. Entweder in Richtung des Ziels von Labyrinth 1 oder in Richtung des Ziels von Labyrinth 2.
...
\\
\\
Affällig ist, dass der Graph mit zunehmendem $l$ gegen die Anzahl der Schritte des optimalen Weges konvergiert.
Ebenso erkennbar ist ein kleiner Hügel. 
Hier wird für ein größeren Wert von $l$ ein schlechterer Pfad gefunden.
...
Der Einfluss dieser Hügel wird daher mit wachsendem $l$ vernachlässigbar.
...
\\
Allgemein kann die maximale Anzahl an Iterationen in Abhängigkeit von $l$ kann wie folgt berechnet werden.
\begin{equation}
  l\cdot(2c_1+c_2)
