...
Ich habe mich dazu entschieden, sie anstelle einer W-Seminararbeit im Leitfach Pyhsik zum Thema Klima abzugeben.\\
In der zweiten Runde des Wettbewerb wurden drei Aufgaben gestellt, von denen zwei zu bearbeiten und schriftlich auszuarbeiten werden mussten.
...
Oft wird die Aufgabe selber noch ein Teilaufgaben unterteilt, welche den Schwierigkeitsgrad schrittweise erhöhen.
...
wobei gute Ausarbeitungen Zusatzpunkte geben können und unvollständige Bearbeitungen Punktabzüge nach sich ziehen.\\
...
Beide Teile sind gleich aufgebaut und orientiert sich, 
abgesehen von der Erweiterung um die Einleitung und dem Vergleich mit der Musterlösung, 
an der Struktur der Vorlagen des BwInf-Teams.\\
Zuerst erkläre ich kurz die Aufgabestellung. 
Danach beschreibe ich meine theorietische Umsetzung und zeige im Anschluss, wie ich sie praktisch umgesetzt habe.
...
Ein präfixfreie Code ist ein Code bei dem kein Codewort der  Anfang eines Codewortes ist. (vlt. Zitat woher das kommt) 
Dadurch lässt sich jede Nachricht eindeutig codieren und wieder decodieren.
Ein Beispiel für eine solchen Code wäre das Morsealphabet.
...
Ich bearbeite zuerst die Aufgabe, mit den gleichen Durchmessern, und anschließen mit unterschiedlichen Durchmessern.
...
1. ein Greedy-Algorithmus bassierend auf Huffman [3]\\
...
Ist der nächste Schritt in einem Labyrinth blockiert, bleibt die Person stehen.
...
Insgesamt lagen meine Ergebnisse, aus geschlossen von Testfall 8, bei 1,1\% Abweichung vom optimal Wert.
