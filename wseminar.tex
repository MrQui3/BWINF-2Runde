...
Der Wettbewerb wird von der BWINF gGmbH ausgerichtet und vom Bundesministerium für Bildung, Familie, Senioren, Frauen und Jugend sowie den Kultusministerien der Länder unterstützt.[11]
...
Für jeden Buchstaben ist ein Codewort aus Perlen zu finden, wobei insgesamt ein präfixfreier Code entstehen muss.[5]
...
\enquote{Ein Code C heißt Prafix-Code (irreduzibler Code), wenn kein Codewort aus C Prafix eines anderen Codeworts von C ist.}[10]
Dadurch lässt sich jede Nachricht eindeutig codieren und wieder decodieren.[10]
...
während in der zweiten Teilaufgabe die Perlen unterschiedliche Durchmesser besitzen.[5]
...
\\
 Stellt man nun Bäume nicht nach ihrer Ebene, sondern nach ihren Kosten dar, erhält man einen \textit{lopsided tree}[1] (Abbildung \ref{fig:lopsided tree}).\\
 \begin{figure}[h]
  \centering
...
Dabei ist es zentral, dass die Wahrscheinlichkeitsverteilung der zu kodierenden Codewörter möglichst in großen Gruppen mit gleich großer Wahrscheinlichkeit eingeordnet werden können.[2]
...
Aktuell bekannte Verfahren für exakte Ergebnisse besitzen eine exponentielle Laufzeit.[1]
...
die dritte ist dessen Erweiterung von Mordecai J. Golin und Günter Rote.[6]
...
Mein Algorithmus hat dabei eine durchschnittliche Abweichung von 1,27\% vom Idealergebnis, besitzt jedoch im Gegensatz dazu eine sehr viel kürzere Laufzeit.[6]
...
Wenn ein Spieler in eine Grube fällt, wird seine Position auf die Startposition (0, 0) zurückgesetzt.[5]
...
Wie in meiner Kostenmatrix wird auch hier für jede Position die Distanz zum Ziel berechnet.[6]
Der wesentliche Unterschied liegt vor allem in dem effizienteren Warteschlagenmodell der Musterlösung.\\
Insgesamt lagen meine Ergebnisse, aus geschlossen von Testfall 8, bei 1,1\% Abweichung vom Optimalwert.[6]
...
[2] Mordecai J. Golin, Claire Mathieu und Neal E. Young, \textit{HUFFMAN CODING WITH LETTER COSTS: A LINEAR-TIME APPROXIMATION SCHEME}, 2012 Society for Industrial and Applied Mathematics Vol. 41, No. 3, pp. 684–713 \\
...
[11] \url{https://bwinf.de/ueber-uns/bwinf/}, aufgrufen am 21.10.2025
