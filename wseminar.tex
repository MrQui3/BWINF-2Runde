...
\subsection{theorietische Erklärung des Algorithmus}
...
\subsection{Vergleich zur Musterlösung}
...
Die ursprüngliche Aufgabe enthält normale Labyrinth, in dem Spezialfall werden die Labyrinth um Gruben erweitert.
...
In Abbildung \ref{fig:lybnmatrix} ist ein Labyrinth mir dazugehöriger Matrix abgebildet.
\begin{figure}[H]
  \centering
...
Daraus folgt, dass die Kosten der Grubenfelder den Startkosten entsprechen.
...
Das word solange wiederholt, bis der $stack$ leer ist.
...
\\
Zu Beginn wird ein $Solving$-Objekt initalisiert und eine leere Liste $moves_stack$ angelegt, in der alle aktuellen Wege gespeichert werden.
Anschließend wird ein erstes $Move$-Objekt erzeugt, dessen Startposition ((0, 0), (0, 0)) ist und seine moves leer sind.
In jedem Schritt wird das erste Element aus der $moves_stack$ Liste entnommen.
...
Das führt zu insgesammt $2^{(nm)^2}$ verschiedenen Möglichkeiten.
...
Der Unterschied liegt vor allem in einem effizienteren Warteschlagenmodell der Musterlösung.\\
...
Eine offene Aufgabe dieser Arbeit besteht noch im Beweis der NP-Härte für Aufgabe 2 sowie einer genaueren Laufzeitanlyse.\\
Insgesamt konnte ich mit 38 von 40 Punkten den zweiten Platz erreichen und gehörte damit zu den 60 besten Teilnehmenden.
Aufgrund dieser Leistung wurde ich für die Internationale Informatik-Olympiade vorgeschlagen und nehme derzeit an derren Training teil.
...
Das sind meine Ergebnisse der Testfälle. 
Die vorgegebenen Testfälle können in Quelle 7 nachgeschaut werden und die zu erwarteten Ergebnisse in Quelle 6.
\subsubsection{Aufgabe 1: Schmucknachrichten}
schmuck0.txt: Gesamtkosten 114\\
schmuck00.txt: Gesamtkosten 382\\
schmuck01.txt: Gesamtkosten 1165\\
schmuck1.txt: Gesamtkosten 194\\
schmuck2.txt: Gesamtkosten 135\\
schmuck3.txt: Gesamtkosten 279\\
schmuck4.txt: Gesamtkosten 137\\
schmuck5.txt: Gesamtkosten 3189\\
schmuck6.txt: Gesamtkosten 234\\
schmuck7.txt: Gesamtkosten 135409\\
schmuck8.txt: Gesamtkosten 3358\\
schmuck9.txt: Gesamtkosten 38635\\
\subsubsection{Aufgabe 2: Simultane Labyrinthe}
labyrinthe0.txt: Weglänge 8\\
labyrinthe1.txt: Weglänge 31\\
labyrinthe2.txt: Weglänge 66\\
labyrinthe3.txt: Weglänge 166\\
labyrinthe4.txt: Weglänge 14497\\
labyrinthe5.txt: Weglänge 1345\\
labyrinthe6.txt: Weglänge 1844\\
labyrinthe7.txt: Keine Lösung\\
labyrinthe8.txt: Weglänge 1433\\
labyrinthe9.txt: Weglänge 1036\\
