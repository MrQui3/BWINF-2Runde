...
während in der zweiten Teilaufgabe die Perlen unterschiedliche Durchmesser besitzen. [vgl. 5]\\
...
In einem solchen Baum entspricht jedes Blatt einem Codewort. 
Die Kanten auf dem Weg von der Wurzel zu einem Blatt repräsentieren dabei die Symbole des jeweilige Codewortes.
Diese präfixfreie Eigenschaft ergibt sich automatisch aus der Baumstruktur: 
Sobald ein Blatt erreicht wird, endet das Codewort, und keine weiteren Knoten bzw. Symbole können daran angeschlossen werden.
